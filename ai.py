...
async def generate_poll(
    ...
    prompt = (
        ...
        f"Дай 2 или 3 самых ярких варианта ответа, которые СТРОГО "
        f"соответствуют противоположным позициям из твоего вопроса "
        f"(например: 'Обожаю' против 'Ненавижу', избегай ухода в абстрактную философию).\n"
        f"{recent_text}\n\n"
